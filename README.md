...
| 人群 | 原因 |
|------|------|
| **正处于急性危机中的人**（72小时内有自杀念头、严重解离、或正在遭受活跃暴力） | 这个系统无法提供紧急干预。请优先联系当地的危机热线、警察或医疗急救服务。安全永远是第一步。 |
| **日常关系困惑的人**（如"感情变淡""性格不合""未来规划不一致"） | 这个系统是**高度聚焦的分析工具**，专门针对控制型关系。普通的关系困惑不需要"控制框架"，不需要对人格和系统做深度挖掘。普通的倾听和讨论就能帮助你——不要用显微镜看感冒。 |
| **想用这套语言攻击或标签他人的人** | 这个系统不是武器。角色模型是用来理解系统的——不是用来在争吵中给对方贴标签的证据库。如果你带着"我要证明TA是什么"的目的来用——你会误用它。 |
| **未成年人独立使用** | 10个角色模型涉及暴力模式、精神操纵、制度控制等高度复杂的成人关系内容。如果你未成年且正在被控制——请找信任的成年人帮助你，而不是独自使用这个系统。 |
| **正在经历普通分手/心碎的人** | 分手真的很痛。但一段关系让你痛，不等于它是一台控制机器。这个框架会把普通的结束误读成某种系统在运行。难过不需要被分析——允许自己只是难过。 |
| **刚经历创伤事件还没缓过来的人**（最近3个月内） | 有些模型会让你回去看那些最难的事。你还没缓过来的时候，大脑最需要的是安稳，不是解剖。等你感觉脚下有地了，再来。 |
