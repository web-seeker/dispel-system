...
| **正在经历普通分手/心碎的人** | 分手是痛苦的。但分手≠控制型关系。这个框架会把一段普通的结束误读为"系统在运行"。疼痛本身不需要被框架化——悲伤是正常的，心碎不是病理。 |
| **处于创伤急性期（创伤事件发生后3个月内）** | 本系统的部分模型会引导你回顾和拆解创伤经历。在急性期内，大脑需要的是稳定和安全感，不是深度分析。先稳定，再反思。 |
